...
export async function initDb() {
  ...
  await query("ALTER TABLE resources ADD COLUMN IF NOT EXISTS status ENUM('processing','draft','published','rejected') NOT NULL DEFAULT 'processing'");
  await query("ALTER TABLE resources ADD COLUMN IF NOT EXISTS ai_analysis JSON NULL");
  await query("ALTER TABLE resources ADD COLUMN IF NOT EXISTS duplicate_checked BOOLEAN NOT NULL DEFAULT FALSE");
